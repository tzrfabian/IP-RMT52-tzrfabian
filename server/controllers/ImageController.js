...
class ImageController {
    ...
    static async sendToMailById(req, res, next) {
        try {
            ...
            // Nodemailer email message with attachment
            let message = {
                from: "fabiantenzara@gmail.com",
                to: req.user.email, // Recipient's email
                subject: "Your Animage Result",
                html: mail, // HTML email generated by Mailgen
                attachments: [
                    {
                        filename: imgData.imgName || 'image.jpg', // Image filename
                        content: imgBuffer, // Buffer containing image data
